    ...
    <main className="min-h-screen bg-white">
      ...
      <article className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <div className="mt-10 space-y-8 text-base leading-7 text-slate-600">
          ...
          <section><h2 className="text-xl font-bold text-slate-950">Payments and credits</h2><p className="mt-2">PayPal processes checkout and payment details under its own privacy policy. ListingCut stores the PayPal order and capture identifiers, purchased plan, USD amount, credit balance, credit usage, and relevant timestamps. ListingCut does not receive or store your full card or bank account details.</p></section>
          ...
          <section><h2 className="text-xl font-bold text-slate-950">Analytics and feedback</h2><p className="mt-2">We use Google Analytics to understand anonymous page-level activity, such as page views and interactions. Google Analytics may use cookies or similar identifiers under the <a href="https://policies.google.com/privacy" className="font-semibold text-violet-700 hover:text-violet-900">Google Privacy Policy</a>. Images and file names are not sent through analytics or feedback links unless you explicitly choose to share them.</p></section>

    ...
    <main className="min-h-screen bg-white">
      ...
      <article className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <div className="mt-10 space-y-8 text-base leading-7 text-slate-600">
          <section><h2 className="text-xl font-bold text-slate-950">No product image storage</h2><p className="mt-2">This site does not use a database, object storage, KV, or image history. Original files and processed results exist only during the active request and your current browser session.</p></section>
